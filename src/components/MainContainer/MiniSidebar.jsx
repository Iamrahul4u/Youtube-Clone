function MiniSidebar() {
  return (
    <div className='md:flex fixed -z-10 flex-col items-center w-16 h-screen py-8 space-y-4 -mt-10 hidden  bg-white '>
      <a
        className='p-1.5  focus:outline-nones cursor-pointer  transition-colors duration-200 rounded-lg text-gray-800 hover:text-white hover:bg-gray-800 '
        target='_blank'
      >
        <svg
